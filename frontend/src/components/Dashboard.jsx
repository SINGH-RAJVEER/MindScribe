...
function Dashboard() {
  const { chatHistory, setChatHistory, selectedConversation, setSelectedConversation, loading } = useChatStore();
  ...
  return (
    ...
    <div className="flex flex-1 flex-col">
      ...
      {/* Chat Messages */}
      <div className="rounded-lg bg-gray-800 p-4 shadow-lg h-[80vh] overflow-y-auto flex flex-col">
